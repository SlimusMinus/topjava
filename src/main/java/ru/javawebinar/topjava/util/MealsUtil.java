...
public class MealsUtil {
    ...
    public static final List<Meal> mealsAdmin = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 29, 10, 0), "Яичница", 500),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 29, 13, 0), "Харчо", 1000),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 29, 20, 0), "Вино и стэйки", 1500)
    ...
    public static List<Meal> getFilteredTos(List<Meal> meals, LocalDate startDate, LocalDate endDate, LocalTime startTime, LocalTime endTime) {
        return meals.stream().
