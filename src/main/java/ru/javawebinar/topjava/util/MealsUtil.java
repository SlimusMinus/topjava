...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 10, 0), "Яичница", 500, 1),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 13, 0), "Харчо", 1000, 1),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 20, 0), "Вино и стэйки", 1500, 1),
